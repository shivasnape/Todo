...
import com.shivichu.passwordsaver.databinding.TodoItemBinding
import com.shivichu.passwordsaver.delegate.OnDeleteClicked
import com.shivichu.passwordsaver.viewModel.ToDoViewModel

class TodoAdapter(private val viewModel: ToDoViewModel, list : MutableList<Todo>) : RecyclerView.Adapter<TodoAdapter.MyViewHolder>() {
